...
{
$contrato = new Contratos($_GET['id']);
?>
<html>
<head>
	<meta http-equiv="Content-type" content="text/html; charset=iso-8859-2" />
...
<Tr>
    ...
    <Td>
        <input type="text" disabled="true" size="10" name="NU_CONTRATO" value="<?php echo $contrato->NU_CONTRATO;?>">
    </td>
</tr>
<Tr>
    <Td>
    ...
    <Td>
        <input type="text" disabled="true" size="10" name="ORIGEM" value="<?php echo $contrato->ORIGEM;?>">
    </td>
</tr>
<tr>
    <Td>
    ...
    <Td>
        <select disabled="true" name="SIS_AMORTIZACAO" id="ID_SIS_AMORTIZACAO">
                <option><?php echo $contrato->sisAmortizacao($contrato->SIS_AMORTIZACAO);?></option>
        </select>
    </td>
</tr>
<tr>
    ...
    <Td>
        <input type="text" disabled="true" name="TX_JUROS" id="ID_TX_JUROS" size="10" value="<?php echo $contrato->TX_JUROS;?>">
    </td>
</tr>
<tr>
    <Td>
    ...
    <Td>
        <input type="text" id="ID_PRAZO_AMORTIZACAO" name="PRAZO_AMORTIZACAO" onblur="calculo();" size="10" value="<?php if ($_GET['PRAZO_AMORTIZACAO']) {echo $_GET['PRAZO_AMORTIZACAO']} else {echo $cadastro->PRAZO_AMORTIZACAO};?>">
    </td>
</tr>
<tr>
    <Td>

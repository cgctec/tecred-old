...
<span class="titulo-box-editar">Alterar Seguradora</span>
<form  method="post" action="alt_seguradora_grava.php" name="form">
...
<tr>
    ...
    <td>
        <input disabled="true" type="text" size="5" value="<?php echo $participante->origem_destino;?>">
    </td>
</tr>
<Tr>
    <Td style="">

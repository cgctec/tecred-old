<?php session_start(); include 'head.php'; ?>
		...
		<div id="conteudo" class="grid_9 scroll omega">
			...
			<div id="formulario">
				<form method="post" action="inc_roteiro_grava.php">
					<fieldset>
                                                  <input type="hidden" name="tipo" value="sistemas">
                                                  <div class="campos">
                                                  <label>Sigla:</label> <input name="sigla" type="text" class="campo" size="10" maxlenght="10" />
                                                  </div>
					<div class="campos">
					<label>Nome:</label>

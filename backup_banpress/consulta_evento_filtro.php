...
<body onload="changeUrl();">
		...
		<div id="conteudo" class="grid_9 scroll omega">
			...
			<div id="formulario">
                              ...
                              <table>
                              <tr>
                              <td><label>Roteiro: </label></td><td><select name="sistema" id="id_sistema" onchange="changeUrl();"><option value="0">Todos</option><?php foreach (Misc::getSistemasList() as $option) {echo $option;} ?></select></td>
                              </tr>
                              <tr>

...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 03-Nov-2019 às 01:04
...
--
-- Database: `cgctecco_tecred_old`
--

-- --------------------------------------------------------

--
-- Estrutura da tabela `acoes_bloqueio`
--

DROP TABLE IF EXISTS `acoes_bloqueio`;
...
--
-- Extraindo dados da tabela `acoes_bloqueio`
--
...
--
-- Estrutura da tabela `controle_processamento`
--

DROP TABLE IF EXISTS `controle_processamento`;
...
--
-- Extraindo dados da tabela `controle_processamento`
--
...
--
-- Estrutura da tabela `historico_seguradora`
--

DROP TABLE IF EXISTS `historico_seguradora`;
CREATE TABLE IF NOT EXISTS `historico_seguradora` (
  `NU_HISTORICO` int(11) NOT NULL AUTO_INCREMENT,
  `COD_SEGURADORA` int(11) NOT NULL,
  `TAXA` decimal(7,4) NOT NULL,
  `INICIO` date NOT NULL,
  `FIM` date NOT NULL,
  `TIPO_SEGURO` char(20) NOT NULL,
  PRIMARY KEY (`NU_HISTORICO`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `historico_seguradora`
--

INSERT INTO `historico_seguradora` (`NU_HISTORICO`, `COD_SEGURADORA`, `TAXA`, `INICIO`, `FIM`, `TIPO_SEGURO`) VALUES
(1, 4, '2.0000', '1950-12-31', '1990-12-31', 'SCI'),
(2, 4, '3.0000', '1991-01-01', '2000-01-01', 'MIP'),
(3, 4, '4.0000', '2000-01-02', '2010-11-07', 'DFP'),
(4, 4, '8.0000', '2010-11-18', '2010-11-27', 'SCI');
...
--
-- Estrutura da tabela `imovel_padrao`
--

DROP TABLE IF EXISTS `imovel_padrao`;
...
--
-- Extraindo dados da tabela `imovel_padrao`
--
...
--
-- Estrutura da tabela `imovel_tipo_construcao`
--

DROP TABLE IF EXISTS `imovel_tipo_construcao`;
...
--
-- Extraindo dados da tabela `imovel_tipo_construcao`
--
...
--
-- Estrutura da tabela `modelo_sintatico`
--

DROP TABLE IF EXISTS `modelo_sintatico`;
...
--
-- Extraindo dados da tabela `modelo_sintatico`
--
...
--
-- Estrutura da tabela `participante_contrato`
--

DROP TABLE IF EXISTS `participante_contrato`;
...
--
-- Extraindo dados da tabela `participante_contrato`
--
...
--
-- Estrutura da tabela `roteiro_sistema_momento`
--

DROP TABLE IF EXISTS `roteiro_sistema_momento`;
...
--
-- Estrutura da tabela `saldo_contrato`
--

DROP TABLE IF EXISTS `saldo_contrato`;
...
--
-- Estrutura da tabela `saldo_fgts`
--

DROP TABLE IF EXISTS `saldo_fgts`;
...
CREATE TABLE IF NOT EXISTS `seguradoras` (
  `COD_SEGURADORA` int(11) NOT NULL AUTO_INCREMENT,
  `NOME` char(200) NOT NULL,
...
INSERT INTO `seguradoras` (`COD_SEGURADORA`, `NOME`, `ORIGEM_DESTINO`, `endereco`, `numero`, `complemento`, `bairro`, `cidade`, `estado`, `telefone`, `cep`, `cnpj`, `email`) VALUES
(3, 'Seguradora 1', 10, 'Rua Alberto Ribeiro de Miranda', 157, '', 'Ingá', 'Betim', 'MG', '(31) 2571-0037', '32632-070', '00.000.000/0000-00', 'renatodinizwc@gmail.com'),
(4, 'Seguradora 2', 10, 'Rua Alberto Ribeiro de Miranda', 157, '', 'Ingá', 'Betim', 'MG', '(31) 2571-0037', '32632-070', '00.000.000/0000-00', 'renatodinizwc@gmail.com');
...
--
-- Estrutura da tabela `tabela_contrato`
--
...
--
-- Estrutura da tabela `tabela_movimento`
--

DROP TABLE IF EXISTS `tabela_movimento`;
...
--
-- Extraindo dados da tabela `tabela_movimento`
--
...
(NULL, '2010-11-12', 10, 20, 30, 40, 50, 18, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2010-11-01 19:44:02');
...
(18, 'Teste', 1289354400, 1289613600, 'N', '7', '', '', '2010-11-02 16:12:14');
